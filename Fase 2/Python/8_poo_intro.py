...
# Un objeto de una clase derivada es al mismo tiempo un objeto de la clase padre, de forma que allí donde se requiere un objeto 
# de la clase padre también se puede utilizar uno de la clase hija.
...
# aunque se puede conseguir un comportamiento similar recurriendo 
