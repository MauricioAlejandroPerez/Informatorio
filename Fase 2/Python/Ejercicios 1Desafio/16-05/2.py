...
tetris y muñecas. Suele hacer venta por correo y la empresa 
...
'''
CantPayasos = int(input("Ingrese la cantidad de payasos que hay en el pedido: \n"))
CantMuñecas = int(input("Ingrese la cantidad de muñecas que hay en el pedido: \n"))

PesoPaquete = (CantMuñecas * .075 + CantPayasos * .112)

print(f"El peso del paquete es de {PesoPaquete:.2f} Kgs.")