...
* Por día: el cliente paga un monto fijo por día (el día son 24 horas) no importa si el auto se 
  devuelve antes. La cantidad de días debe definir al momento del alquiler. El costo es de $ 2000 / día.
...
* Si quien alquila es una empresa (cuit empieza con 26) tiene un descuento del 5% como parte de la política 
  de fidelización de clientes
* Si el auto es devuelto luego de finalizado el tiempo establecido al momento de alquiler, se cobra un recargo del 100%.

Hacer un programa que permita calcular la correspondiente facturación para los alquileres, debes diseñar las clases que 
consideres adecuadas con los datos convenientes.
'''