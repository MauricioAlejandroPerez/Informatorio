...
Su función debe devolver 1 para + y -, 2 para * y /, y 3 para ^. Si la cadena que se pasa a la función no es 
...
En este ejercicio, se usa ^ para representar la exponenciación, en lugar de la elección de Python de **, para 
facilitar el desarrollo de la solución.
'''